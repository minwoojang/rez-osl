...
echo -e "[INSTALL][ARGS] OSL VERSION: ${OSL_VERSION}"

# We check if the arguments variables we need are correctly set.
# If not, we abort the process.
if [[ -z ${BUILD_PATH} || -z ${OSL_VERSION} ]]; then
    echo -e "\n"
...
# We install OSL.
echo -e "\n"
echo -e "[INSTALL] Installing OSL-${OSL_VERSION}..."
echo -e "\n"
...
echo -e "\n"
echo -e "[INSTALL] Finished installing OSL-${OSL_VERSION}!"
echo -e "\n"
